...
function showBanner() {
    ...
    console.log(chalk.gray('Multi-Database Backup & Restore Tool v2.1.2\n'));
}

const program = new Command();
program.version('2.1.2').description('Multi-DB backup & rotation tool with beautiful logging & restore locations').option('-c, --config <path>', 'Config file path', './src/config/config.json');
...
function showBeautifulHelp() {
    console.log(chalk.cyan('\n🚀 PowerBackup v2.1.2 - Quick Start Guide\n'));
