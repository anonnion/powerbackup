...
**NEW in v2.3.0: Full REST API** — PowerBackup now includes a secure REST API for automation, integration, and web-based management.
...
*Version 2.3.0 — The Beautiful Backup Experience*
